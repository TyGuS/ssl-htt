...
Lemma pure3 (k2 : nat) : (k2) <= (7) -> (0) <= (k2) -> ((if (k2) <= (7) then k2 else 7)) = ((if (k2) <= (7) then k2 else 7)). intros; hammer. Qed.
...
Lemma pure5 (k2 : nat) : (k2) <= (7) -> (0) <= (k2) -> ((if (0) <= (k2) then k2 else 0)) = ((if (0) <= (k2) then k2 else 0)). intros; hammer. Qed.
Hint Resolve pure5: ssl_pure.
Lemma pure6 (sz1x : nat) (sz2x : nat) : (0) <= (((1) + (sz1x)) + (sz2x)) -> (0) <= (sz2x) -> (0) <= (sz1x) -> ((((1) + (sz1x)) + (sz2x)) + (1)) = (((1) + ((sz1x) + (1))) + (sz2x)). intros; hammer. Qed.
Hint Resolve pure6: ssl_pure.
Lemma pure7 (sz1x : nat) (sz2x : nat) : (0) <= (((1) + (sz1x)) + (sz2x)) -> (0) <= (sz2x) -> (0) <= (sz1x) -> (0) <= ((sz1x) + (1)). intros; hammer. Qed.
Hint Resolve pure7: ssl_pure.
Lemma pure8 (lo2x : nat) (vx2 : nat) (k2 : nat) (hi1x : nat) (hi2x : nat) : (vx2) <= (lo2x) -> (0) <= (vx2) -> (hi1x) <= (vx2) -> (k2) <= (vx2) -> (vx2) <= (7) -> (0) <= (k2) -> (k2) <= (7) -> ((if ((if (hi2x) <= (vx2) then vx2 else hi2x)) <= (k2) then k2 else (if (hi2x) <= (vx2) then vx2 else hi2x))) = ((if (hi2x) <= (vx2) then vx2 else hi2x)).
  (* intros; hammer. *)
  intros; destruct (hi2x <= vx2) eqn:H6; sauto.
Qed.
Hint Resolve pure8: ssl_pure.
Lemma pure9 (lo2x : nat) (vx2 : nat) (k2 : nat) (hi1x : nat) (lo1x : nat) : (vx2) <= (lo2x) -> (0) <= (vx2) -> (hi1x) <= (vx2) -> (k2) <= (vx2) -> (vx2) <= (7) -> (0) <= (k2) -> (k2) <= (7) -> ((if (k2) <= ((if (vx2) <= (lo1x) then vx2 else lo1x)) then k2 else (if (vx2) <= (lo1x) then vx2 else lo1x))) = ((if (vx2) <= ((if (k2) <= (lo1x) then k2 else lo1x)) then vx2 else (if (k2) <= (lo1x) then k2 else lo1x))).
  (* intros; hammer. *)
  intros.
...
Lemma pure12 (sz1x : nat) (sz2x : nat) : (0) <= (((1) + (sz1x)) + (sz2x)) -> (0) <= (sz2x) -> (0) <= (sz1x) -> ((((1) + (sz1x)) + (sz2x)) + (1)) = (((1) + (sz1x)) + ((sz2x) + (1))). intros; hammer. Qed.
Hint Resolve pure12: ssl_pure.
Lemma pure13 (lo2x : nat) (vx2 : nat) (k2 : nat) (hi1x : nat) (hi2x : nat) : (vx2) <= (lo2x) -> (0) <= (vx2) -> (hi1x) <= (vx2) -> (vx2) <= (7) -> (0) <= (k2) -> ~~ ((k2) <= (vx2)) -> (k2) <= (7) -> ((if ((if (hi2x) <= (vx2) then vx2 else hi2x)) <= (k2) then k2 else (if (hi2x) <= (vx2) then vx2 else hi2x))) = ((if ((if (hi2x) <= (k2) then k2 else hi2x)) <= (vx2) then vx2 else (if (hi2x) <= (k2) then k2 else hi2x))).
  (* intros; hammer. *)
  intros.
...
Lemma pure14 (vx2 : nat) (k2 : nat) (lo2x : nat) (hi1x : nat) : (vx2) <= (lo2x) -> (0) <= (vx2) -> (hi1x) <= (vx2) -> (vx2) <= (7) -> (0) <= (k2) -> ~~ ((k2) <= (vx2)) -> (k2) <= (7) -> (vx2) <= ((if (k2) <= (lo2x) then k2 else lo2x)).
  (* intros; hammer. *)
  intros.
...
Lemma pure15 (lo2x : nat) (vx2 : nat) (k2 : nat) (hi1x : nat) (lo1x : nat) : (vx2) <= (lo2x) -> (0) <= (vx2) -> (hi1x) <= (vx2) -> (vx2) <= (7) -> (0) <= (k2) -> ~~ ((k2) <= (vx2)) -> (k2) <= (7) -> ((if (k2) <= ((if (vx2) <= (lo1x) then vx2 else lo1x)) then k2 else (if (vx2) <= (lo1x) then vx2 else lo1x))) = ((if (vx2) <= (lo1x) then vx2 else lo1x)). intros; hammer. Qed.
