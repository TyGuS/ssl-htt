...
Lemma pure3 (len1x : nat) : (0) <= (len1x) -> ((1) + (len1x)) = ((1) + (len1x)). intros; hammer. Qed.
Hint Resolve pure3: ssl_pure.
Lemma pure4 (hi1x1 : nat) (vx1 : nat) : (vx1) <= (7) -> (0) <= (vx1) -> ((if (hi1x1) <= (vx1) then vx1 else hi1x1)) = ((if (hi1x1) <= (vx1) then vx1 else hi1x1)). intros; hammer. Qed.
...
Definition sll_max_type :=
  ...
  STsep (
    fun h =>
      ...
      h = r :-> (a) \+ h_sll_xnlohi_1 /\ sll x n lo hi h_sll_xnlohi_1,
    [vfun (_: unit) h =>
      let: (x, r) := vprogs in
      let: (n, lo, hi, a) := vghosts in
      exists h_sll_xnlohi_2,
      h = r :-> (hi) \+ h_sll_xnlohi_2 /\ sll x n lo hi h_sll_xnlohi_2
    ]).
  ...
  Fix (fun (sll_max : sll_max_type) vprogs =>
    ...
    Do (
      ...
      then
        ...
        sll_max (nxtx1, r);;
        hi1x1 <-- @read nat r;
        r ::= (if (hi1x1) <= (vx1) then vx1 else hi1x1);;
        ret tt
    )).
...
store_valid.
ssl_read r.
try rename hi1x into hi1x1.
try rename h_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_1 into h_sll_xlen1xvx1lo1xvx1lo1xhi1x1vx1vx1hi1x1_1.
try rename H_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_1 into H_sll_xlen1xvx1lo1xvx1lo1xhi1x1vx1vx1hi1x1_1.
try rename h_sll_nxtx1len1xlo1xhi1x_21 into h_sll_nxtx1len1xlo1xhi1x1_21.
try rename H_sll_nxtx1len1xlo1xhi1x_21 into H_sll_nxtx1len1xlo1xhi1x1_21.
try rename h_sll_nxtx1len1xlo1xhi1x_0x into h_sll_nxtx1len1xlo1xhi1x1_0x.
try rename H_sll_nxtx1len1xlo1xhi1x_0x into H_sll_nxtx1len1xlo1xhi1x1_0x.
try rename h_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_2 into h_sll_xlen1xvx1lo1xvx1lo1xhi1x1vx1vx1hi1x1_2.
try rename H_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_2 into H_sll_xlen1xvx1lo1xvx1lo1xhi1x1vx1vx1hi1x1_2.
try rename h_sll_nxtx2len1x1lo11xhi11x_0x1 into h_sll_nxtx1len1xlo1xhi1x1_21.
try rename H_sll_nxtx2len1x1lo11xhi11x_0x1 into H_sll_nxtx1len1xlo1xhi1x1_21.
ssl_write r.
ssl_write_post r.
ssl_emp;
exists (x :-> (vx1) \+ x .+ 1 :-> (nxtx1) \+ h_sll_nxtx1len1xlo1xhi1x1_21);
sslauto.
ssl_close 2;
exists (len1x), (vx1), (hi1x1), (lo1x), (nxtx1), (h_sll_nxtx1len1xlo1xhi1x1_21);
sslauto.
ssl_frame_unfold.
Qed.