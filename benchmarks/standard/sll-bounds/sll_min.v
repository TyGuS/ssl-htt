...
Lemma pure5 (vx1 : nat) (lo1x1 : nat) : (vx1) <= (7) -> (0) <= (vx1) -> ((if (vx1) <= (lo1x1) then vx1 else lo1x1)) = ((if (vx1) <= (lo1x1) then vx1 else lo1x1)). intros; hammer. Qed.
...
Definition sll_min_type :=
  ...
  STsep (
    ...
    [vfun (_: unit) h =>
      ...
      h = r :-> (lo) \+ h_sll_xnlohi_2 /\ sll x n lo hi h_sll_xnlohi_2
    ]).
  ...
  Fix (fun (sll_min : sll_min_type) vprogs =>
    ...
    Do (
      ...
      then
        ...
        sll_min (nxtx1, r);;
        lo1x1 <-- @read nat r;
        r ::= (if (vx1) <= (lo1x1) then vx1 else lo1x1);;
        ret tt
    )).
...
try rename h_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_1 into h_sll_xlen1xvx1lo1x1vx1lo1x1hi1xvx1vx1hi1x_1.
try rename H_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_1 into H_sll_xlen1xvx1lo1x1vx1lo1x1hi1xvx1vx1hi1x_1.
try rename h_sll_nxtx1len1xlo1xhi1x_21 into h_sll_nxtx1len1xlo1x1hi1x_21.
try rename H_sll_nxtx1len1xlo1xhi1x_21 into H_sll_nxtx1len1xlo1x1hi1x_21.
try rename h_sll_nxtx1len1xlo1xhi1x_0x into h_sll_nxtx1len1xlo1x1hi1x_0x.
try rename H_sll_nxtx1len1xlo1xhi1x_0x into H_sll_nxtx1len1xlo1x1hi1x_0x.
try rename h_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_2 into h_sll_xlen1xvx1lo1x1vx1lo1x1hi1xvx1vx1hi1x_2.
try rename H_sll_xlen1xvx1lo1xvx1lo1xhi1xvx1vx1hi1x_2 into H_sll_xlen1xvx1lo1x1vx1lo1x1hi1xvx1vx1hi1x_2.
try rename h_sll_nxtx2len1x1lo11xhi11x_0x1 into h_sll_nxtx1len1xlo1x1hi1x_21.
try rename H_sll_nxtx2len1x1lo11xhi11x_0x1 into H_sll_nxtx1len1xlo1x1hi1x_21.
ssl_write r.
ssl_write_post r.
ssl_emp;
exists (x :-> (vx1) \+ x .+ 1 :-> (nxtx1) \+ h_sll_nxtx1len1xlo1x1hi1x_21);
sslauto.
ssl_close 2;
exists (len1x), (vx1), (hi1x), (lo1x1), (nxtx1), (h_sll_nxtx1len1xlo1x1hi1x_21);
sslauto.
ssl_frame_unfold.
Qed.