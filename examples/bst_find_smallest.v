...
Lemma pure28 hi2x lo2x hi1x vx2 lo1x : hi1x <= vx2 -> vx2 <= lo2x -> (if hi2x <= vx2 then vx2 else hi2x) <= 7 -> 0 <= vx2 -> vx2 <= 7 -> 0 <= (if vx2 <= lo1x then vx2 else lo1x) -> 0 <= lo1x. Admitted.
Hint Resolve pure28: ssl_pure.
Lemma pure29 hi2x lo2x hi1x vx2 lo1x : hi1x <= vx2 -> vx2 <= lo2x -> (if hi2x <= vx2 then vx2 else hi2x) <= 7 -> 0 <= vx2 -> vx2 <= 7 -> 0 <= (if vx2 <= lo1x then vx2 else lo1x) -> hi1x <= 7. Admitted.
...
Lemma pure31 hi2x lo2x hi1x vx2 lo1x2 : 0 <= (if vx2 <= lo1x2 then vx2 else lo1x2) -> hi1x <= vx2 -> vx2 <= lo2x -> (if hi2x <= vx2 then vx2 else hi2x) <= 7 -> 0 <= vx2 -> vx2 <= 7 -> (if hi2x <= vx2 then vx2 else hi2x) == (if hi2x <= vx2 then vx2 else hi2x). Admitted.
Hint Resolve pure31: ssl_pure.
Lemma pure32 hi2x lo2x hi1x vx2 lo1x2 : 0 <= (if vx2 <= lo1x2 then vx2 else lo1x2) -> hi1x <= vx2 -> vx2 <= lo2x -> (if hi2x <= vx2 then vx2 else hi2x) <= 7 -> 0 <= vx2 -> vx2 <= 7 -> (if vx2 <= lo1x2 then vx2 else lo1x2) == (if vx2 <= lo1x2 then vx2 else lo1x2). Admitted.
...
try rename H_bst_xsz1xsz2xvx2lo1xvx2lo1xhi2xvx2vx2hi2x_a into H_bst_xsz1xsz2xvx2lo1x2vx2lo1x2hi2xvx2vx2hi2x_a.
try rename h_bst_lx1sz11xlo11xhi11x_521x1 into h_bst_lx1sz11xlo11xhi11x_c1.
try rename H_bst_lx1sz11xlo11xhi11x_521x1 into H_bst_lx1sz11xlo11xhi11x_c1.
try rename h_bst_lx1sz11xlo11xhi11x_c1 into h_bst_lx1sz11xlo11xhi1x_c1.
try rename H_bst_lx1sz11xlo11xhi11x_c1 into H_bst_lx1sz11xlo11xhi1x_c1.
try rename h_bst_lx1sz11xlo11xhi1x_c1 into h_bst_lx1sz11xlo1x2hi1x_c1.
try rename H_bst_lx1sz11xlo11xhi1x_c1 into H_bst_lx1sz11xlo1x2hi1x_c1.
try rename h_bst_lx1sz11xlo1x2hi1x_c1 into h_bst_lx2sz11xlo1x2hi1x_c1.
try rename H_bst_lx1sz11xlo1x2hi1x_c1 into H_bst_lx2sz11xlo1x2hi1x_c1.
try rename h_bst_lx2sz11xlo1x2hi1x_c1 into h_bst_lx2sz1xlo1x2hi1x_c1.
try rename H_bst_lx2sz11xlo1x2hi1x_c1 into H_bst_lx2sz1xlo1x2hi1x_c1.
try rename h_bst_rx1sz2x1lo2x1hi2x1_522x1 into h_bst_rx1sz2x1lo2x1hi2x1_522x.
try rename H_bst_rx1sz2x1lo2x1hi2x1_522x1 into H_bst_rx1sz2x1lo2x1hi2x1_522x.
try rename h_bst_rx1sz2x1lo2x1hi2x1_522x into h_bst_rx1sz2x1lo2x1hi2x_522x.
try rename H_bst_rx1sz2x1lo2x1hi2x1_522x into H_bst_rx1sz2x1lo2x1hi2x_522x.
try rename h_bst_rx1sz2x1lo2x1hi2x_522x into h_bst_rx1sz2x1lo2xhi2x_522x.
try rename H_bst_rx1sz2x1lo2x1hi2x_522x into H_bst_rx1sz2x1lo2xhi2x_522x.
try rename h_bst_rx1sz2x1lo2xhi2x_522x into h_bst_rx2sz2x1lo2xhi2x_522x.
try rename H_bst_rx1sz2x1lo2xhi2x_522x into H_bst_rx2sz2x1lo2xhi2x_522x.
try rename h_bst_rx2sz2x1lo2xhi2x_522x into h_bst_rx2sz2xlo2xhi2x_522x.
try rename H_bst_rx2sz2x1lo2xhi2x_522x into H_bst_rx2sz2xlo2xhi2x_522x.
ssl_write retv.
ssl_write_post retv.
ssl_emp;
