...
| bst_2 of (x == null) = false of
  ...
  exists h_bst_lsz1lo1hi1_562 h_bst_rsz2lo2hi2_563,
  0 <= sz1 /\ 0 <= sz2 /\ 0 <= v /\ hi == (if hi2 <= v then v else hi2) /\ hi1 <= v /\ lo == (if v <= lo1 then v else lo1) /\ sz == 1 + sz1 + sz2 /\ v <= 7 /\ v <= lo2 /\ h = x :-> v \+ x .+ 1 :-> l \+ x .+ 2 :-> r \+ h_bst_lsz1lo1hi1_562 \+ h_bst_rsz2lo2hi2_563 /\ bst l sz1 lo1 hi1 h_bst_lsz1lo1hi1_562 /\ bst r sz2 lo2 hi2 h_bst_rsz2lo2hi2_563.

Lemma pure50 sz1 sz1r2 sz2r2 : 0 <= sz1 -> 0 <= 1 + sz1r2 + sz2r2 -> 0 <= sz2r2 -> 0 <= sz1r2 -> 0 <= 1 + sz1 + sz1r2. Admitted.
Hint Resolve pure50: ssl_pure.
Lemma pure51 sz1 sz1r2 sz2r2 : 0 <= sz1 -> 0 <= 1 + sz1r2 + sz2r2 -> 0 <= sz2r2 -> 0 <= sz1r2 -> 1 + sz1 + sz1r2 + sz2r2 == sz1 + 1 + sz1r2 + sz2r2. Admitted.
Hint Resolve pure51: ssl_pure.
Lemma pure52 lo1r2 vr22 hi1 v2 hi1r2 lo2r2 : vr22 <= 7 -> v2 <= (if vr22 <= lo1r2 then vr22 else lo1r2) -> 0 <= v2 -> vr22 <= lo2r2 -> 0 <= vr22 -> hi1r2 <= vr22 -> hi1 <= v2 -> v2 <= 7 -> v2 <= lo1r2. Admitted.
Hint Resolve pure52: ssl_pure.
Lemma pure53 lo1r2 vr22 hi1 v2 hi1r2 lo2r2 : vr22 <= 7 -> v2 <= (if vr22 <= lo1r2 then vr22 else lo1r2) -> 0 <= v2 -> vr22 <= lo2r2 -> 0 <= vr22 -> hi1r2 <= vr22 -> hi1 <= v2 -> v2 <= 7 -> (if hi1r2 <= v2 then v2 else hi1r2) <= vr22. Admitted.
...
Definition bst_left_rotate_type :=
  ...
  STsep (
    ...
    [vfun (_: unit) h =>
      ...
      exists h_bst_xsz3lo3hi3_564 h_bst_r3sz4lo4hi4_565,
      0 <= sz3 /\ 0 <= sz4 /\ 0 <= v3 /\ hi3 <= v3 /\ sz3 + sz4 == sz1 + sz2 /\ v3 <= 7 /\ v3 <= lo4 /\ h = retv :-> y \+ y :-> v3 \+ y .+ 1 :-> x \+ y .+ 2 :-> r3 \+ h_bst_xsz3lo3hi3_564 \+ h_bst_r3sz4lo4hi4_565 /\ bst x sz3 lo3 hi3 h_bst_xsz3lo3hi3_564 /\ bst r3 sz4 lo4 hi4 h_bst_r3sz4lo4hi4_565
    ]).
...
ex_elim h_bst_lr22sz1r2lo1r2hi1r2_562r2 h_bst_rr22sz2r2lo2r2hi2r2_563r2.
...
move=>[H_bst_lr22sz1r2lo1r2hi1r2_562r2 H_bst_rr22sz2r2lo2r2hi2r2_563r2].
ssl_read (r2 .+ 1).
ssl_write (r2 .+ 1).
ssl_write_post (r2 .+ 1).
ssl_write retv.
...
exists (x :-> v2 \+ x .+ 1 :-> l2 \+ x .+ 2 :-> lr22 \+ h_bst_l2sz1lo1hi1_a \+ h_bst_lr22sz1r2lo1r2hi1r2_562r2);
exists (h_bst_rr22sz2r2lo2r2hi2r2_563r2);
sslauto;
solve [
unfold_constructor 2;
exists (sz1), (sz1r2), (v2), (hi1r2), (hi1), (lo1), (lo1r2), (l2), (lr22);
exists (h_bst_l2sz1lo1hi1_a);
exists (h_bst_lr22sz1r2lo1r2hi1r2_562r2);
sslauto ].
Qed.
