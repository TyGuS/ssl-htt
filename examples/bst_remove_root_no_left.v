...
| bst_2 of ~~ ((x) == (null)) of
  ...
  exists h_bst_lsz1lo1hi1_606 h_bst_rsz2lo2hi2_607,
  (0) <= (sz1) /\ (0) <= (sz2) /\ (0) <= (v) /\ (hi) == ((if (hi2) <= (v) then v else hi2)) /\ (hi1) <= (v) /\ (lo) == ((if (v) <= (lo1) then v else lo1)) /\ (sz) == (((1) + (sz1)) + (sz2)) /\ (v) <= (7) /\ (v) <= (lo2) /\ h = x :-> v \+ x .+ 1 :-> l \+ x .+ 2 :-> r \+ h_bst_lsz1lo1hi1_606 \+ h_bst_rsz2lo2hi2_607 /\ bst l sz1 lo1 hi1 h_bst_lsz1lo1hi1_606 /\ bst r sz2 lo2 hi2 h_bst_rsz2lo2hi2_607.

Lemma pure90 r2 : (r2) = (null) -> ((if (null) == (null) then (if (r2) == (null) then 7 else 7) else 7)) = (7). Admitted.
Hint Resolve pure90: ssl_pure.
Lemma pure91 r2 : (r2) = (null) -> ((if (r2) == (null) then (if (null) == (null) then 0 else 0) else 0)) = (0). Admitted.
Hint Resolve pure91: ssl_pure.
Lemma pure92 : (0) = (0). Admitted.
Hint Resolve pure92: ssl_pure.
Lemma pure93 sz1r2 sz2r2 : (0) <= (((1) + (sz1r2)) + (sz2r2)) -> (0) <= (sz1r2) -> (0) <= (sz2r2) -> (((1) + (sz1r2)) + (sz2r2)) = (((1) + (sz1r2)) + (sz2r2)). Admitted.
Hint Resolve pure93: ssl_pure.
Lemma pure94 lo1r2 vr22 x v2 hi1r2 retv lo2r2 hi2r2 r2 : (v2) <= (7) -> ~~ ((x) == (null)) -> ~~ ((retv) == (null)) -> (0) <= (v2) -> ~~ ((r2) == (null)) -> (0) <= (vr22) -> (v2) <= ((if (vr22) <= (lo1r2) then vr22 else lo1r2)) -> (vr22) <= (7) -> (hi1r2) <= (vr22) -> ~~ ((r2) == (retv)) -> (vr22) <= (lo2r2) -> ~~ ((retv) == (x)) -> ~~ ((r2) == (x)) -> ((if (r2) == (null) then (if (null) == (null) then 0 else 0) else (if (hi2r2) <= (vr22) then vr22 else hi2r2))) = ((if (hi2r2) <= (vr22) then vr22 else hi2r2)). Admitted.
Hint Resolve pure94: ssl_pure.
Lemma pure95 lo1r2 vr22 x v2 hi1r2 retv lo2r2 r2 : (v2) <= (7) -> ~~ ((x) == (null)) -> ~~ ((retv) == (null)) -> (0) <= (v2) -> ~~ ((r2) == (null)) -> (0) <= (vr22) -> (v2) <= ((if (vr22) <= (lo1r2) then vr22 else lo1r2)) -> (vr22) <= (7) -> (hi1r2) <= (vr22) -> ~~ ((r2) == (retv)) -> (vr22) <= (lo2r2) -> ~~ ((retv) == (x)) -> ~~ ((r2) == (x)) -> ((if (null) == (null) then (if (r2) == (null) then 7 else (if (vr22) <= (lo1r2) then vr22 else lo1r2)) else 7)) = ((if (vr22) <= (lo1r2) then vr22 else lo1r2)). Admitted.
Hint Resolve pure95: ssl_pure.
...
ex_elim h_bst_lr2sz1r2lo1r2hi1r2_606r2 h_bst_rr2sz2r2lo2r2hi2r2_607r2.
...
move=>[sigma_bst_r2sz2lo2hi2_b].
subst h_bst_r2sz2lo2hi2_b.
move=>[H_bst_lr2sz1r2lo1r2hi1r2_606r2 H_bst_rr2sz2r2lo2r2hi2r2_607r2].
...
try rename h_bst_lr2sz1r2lo1r2hi1r2_606r2 into h_bst_lr22sz1r2lo1r2hi1r2_606r2.
try rename H_bst_lr2sz1r2lo1r2hi1r2_606r2 into H_bst_lr22sz1r2lo1r2hi1r2_606r2.
ssl_read (r2 .+ 2).
try rename rr2 into rr22.
try rename h_bst_rr2sz2r2lo2r2hi2r2_607r2 into h_bst_rr22sz2r2lo2r2hi2r2_607r2.
try rename H_bst_rr2sz2r2lo2r2hi2r2_607r2 into H_bst_rr22sz2r2lo2r2hi2r2_607r2.
try rename h_bst_l1ysz11ylo11yhi11y_606y into h_bst_lr22sz1r2lo1r2hi1r2_606r2.
try rename H_bst_l1ysz11ylo11yhi11y_606y into H_bst_lr22sz1r2lo1r2hi1r2_606r2.
try rename h_bst_r1ysz21ylo21yhi21y_607y into h_bst_rr22sz2r2lo2r2hi2r2_607r2.
try rename H_bst_r1ysz21ylo21yhi21y_607y into H_bst_rr22sz2r2lo2r2hi2r2_607r2.
...
exists (r2 :-> vr22 \+ r2 .+ 1 :-> lr22 \+ r2 .+ 2 :-> rr22 \+ h_bst_lr22sz1r2lo1r2hi1r2_606r2 \+ h_bst_rr22sz2r2lo2r2hi2r2_607r2);
sslauto.
ssl_close 2;
exists (sz1r2), (sz2r2), (vr22), (hi2r2), (hi1r2), (lo1r2), (lo2r2), (lr22), (rr22), (h_bst_lr22sz1r2lo1r2hi1r2_606r2), (h_bst_rr22sz2r2lo2r2hi2r2_607r2);
sslauto.
ssl_frame_unfold.
ssl_frame_unfold.
ex_elim sz10 sz20 v0 hi20 hi10.
ex_elim lo10 lo20 l0 r0.
ex_elim h_bst_l0sz10lo10hi10_6060 h_bst_r0sz20lo20hi20_6070.
...
move=>[sigma_bst_sz1lo1hi1_a].
subst h_bst_sz1lo1hi1_a.
move=>[H_bst_l0sz10lo10hi10_6060 H_bst_r0sz20lo20hi20_6070].
ssl_inconsistency.
Qed.