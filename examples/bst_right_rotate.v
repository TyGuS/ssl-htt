...
Lemma pure39 sz2l2 sz2 sz1l2 : (0) <= (sz2l2) -> (0) <= (((1) + (sz1l2)) + (sz2l2)) -> (0) <= (sz2) -> (0) <= (sz1l2) -> (0) <= (((1) + (sz2l2)) + (sz2)). Admitted.
Hint Resolve pure39: ssl_pure.
Lemma pure40 sz1l2 sz2l2 sz2 : (0) <= (sz2l2) -> (0) <= (((1) + (sz1l2)) + (sz2l2)) -> (0) <= (sz2) -> (0) <= (sz1l2) -> ((sz1l2) + (((1) + (sz2l2)) + (sz2))) == ((((1) + (sz1l2)) + (sz2l2)) + (sz2)). Admitted.
Hint Resolve pure40: ssl_pure.
Lemma pure41 lo2l2 v2 vl22 hi2l2 lo2 hi1l2 : (v2) <= (lo2) -> (v2) <= (7) -> (hi1l2) <= (vl22) -> ((if (hi2l2) <= (vl22) then vl22 else hi2l2)) <= (v2) -> (0) <= (v2) -> (vl22) <= (lo2l2) -> (vl22) <= (7) -> (0) <= (vl22) -> (hi2l2) <= (v2). Admitted.
Hint Resolve pure41: ssl_pure.
Lemma pure42 lo2l2 v2 vl22 hi2l2 lo2 hi1l2 : (v2) <= (lo2) -> (v2) <= (7) -> (hi1l2) <= (vl22) -> ((if (hi2l2) <= (vl22) then vl22 else hi2l2)) <= (v2) -> (0) <= (v2) -> (vl22) <= (lo2l2) -> (vl22) <= (7) -> (0) <= (vl22) -> (vl22) <= ((if (v2) <= (lo2l2) then v2 else lo2l2)). Admitted.
...
try rename H_bst_xsz4v1xlo11xv1xlo11xhi21xv1xv1xhi21x_528 into H_bst_xsz11xsz21xv1xlo11xv1xlo11xhi21xv1xv1xhi21x_528.
try rename h_bst_l3sz3lo3hi3_527 into h_bst_ll22sz1l2lo1l2hi1l2_525l2.
try rename H_bst_l3sz3lo3hi3_527 into H_bst_ll22sz1l2lo1l2hi1l2_525l2.
try rename h_bst_l1xsz11xlo11xhi11x_525x into h_bst_rl22sz2l2lo2l2hi2l2_526l2.
try rename H_bst_l1xsz11xlo11xhi11x_525x into H_bst_rl22sz2l2lo2l2hi2l2_526l2.
...
try rename H_bst_xsz11xsz21xv1xlo2l2v1xlo2l2hi21xv1xv1xhi21x_528 into H_bst_xsz2l2sz21xv1xlo2l2v1xlo2l2hi21xv1xv1xhi21x_528.
try rename h_bst_r1xsz21xlo21xhi21x_526x into h_bst_r2sz2lo2hi2_b.
try rename H_bst_r1xsz21xlo21xhi21x_526x into H_bst_r2sz2lo2hi2_b.
