...
Lemma pure3 hi1x vx2 : vx2 <= 7 -> 0 <= vx2 -> (if hi1x <= vx2 then vx2 else hi1x) == (if hi1x <= vx2 then vx2 else hi1x). Admitted.
Hint Resolve pure3: ssl_pure.
Lemma pure4 vx2 lo1x : vx2 <= 7 -> 0 <= vx2 -> (if vx2 <= lo1x then vx2 else lo1x) == (if vx2 <= lo1x then vx2 else lo1x). Admitted.
Hint Resolve pure4: ssl_pure.
Lemma pure5 len1x : 0 <= len1x -> 0 <= 1 + len1x -> 1 + len1x == 1 + len1x. Admitted.
...
try rename H_srtl_y2len1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_516 into H_srtl_y22len1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_516.
try rename h_srtl_ylen1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_518 into h_srtl_ylen1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_516.
try rename H_srtl_ylen1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_518 into H_srtl_ylen1xvx2lo1xvx2lo1xhi1xvx2vx2hi1x_516.
